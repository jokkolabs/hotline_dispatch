...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResponseSMS'
        db.create_table(u'dispatcher_responsesms', (
        ...
        db.send_create_signal(u'dispatcher', ['ResponseSMS'])


    def backwards(self, orm):
        # Deleting model 'ResponseSMS'
        db.delete_table(u'dispatcher_responsesms')
